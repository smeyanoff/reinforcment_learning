    ...
    for _ in range(episode_n):
        ...
        for step in range(t_max):
            ...
            if step > batch_size:
                ...
                # Обновление весов нейронных сетей с помощью Soft Target Update
                for target_param, param in zip(
                    target.q_function.parameters(),
                    main.q_function.parameters(),
                ):
...
if __name__ == "__main__":
    ...
    logging = True
    task_name = "HW5_LunarLender_2_soft"
